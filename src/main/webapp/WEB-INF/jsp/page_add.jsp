        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        <form id="f" role="form" action="/page/add_result" method="post">
                            <div class="form-group">
                                <label for="versionId">版本号</label>
                                <input name="versionId" id="versionId" class="form-control" placeholder="版本号">
                            </div>

                            <div class="form-group">
                                <label for="versionName">版本名称</label>
                                <input name="versionName" id="versionName" class="form-control" placeholder="版本名称">
                            </div>

                            <div class="form-group">
                                <label for="headCode">头部代码</label>
                                <textarea name="headCode" id="headCode" class="form-control" rows="3" placeholder="头部代码"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="bodyCode">正文</label>
                                <div class="controls" id="bodyCode">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        //自定义工具栏，方法一：在实例化编辑器的时候传入配置参数.没搞清楚如何通过修改配置文件来修改工具栏
                                        //文本类可以正常储存，图片类储存有问题
