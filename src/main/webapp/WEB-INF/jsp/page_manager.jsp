        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <button type="button" class="btn btn-primary" onClick="location.href='/page/toAdd'">新增页面版本</button>
                    <table  id="pageTable" data-toggle="table" >
                        <thead>
                        <tr>
                            <%--data-field的值为pojo类的属性值，不是数据库字段--%>
                            <th data-field="versionId" >版本号</th>
...
window.actionEvents = {
    'click .edit': function (e, value, row, index) {
        ...
        window.location.href = '/page/toEdit?versionId='+obj.versionId;
        //注：这个是异步的，不适合跳转场合
